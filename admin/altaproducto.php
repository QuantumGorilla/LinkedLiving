			...
			//Verificamos que sea una imagen
	  		if ($_FILES["file"]["error"] > 0){
		    	...
		    	if(file_exists("../productos/".$random.'_'.$_FILES["file"]["name"])){
					...
					$precio=$_POST['precio'];
					$Sql="insert into productos (nombre,Categoria,descripcion,imagen,precio) values(
							'".$producto."',
							'".$categoria."',
							'".$descripcion."',
							'".$imagen."',
	  		...
	  		echo "Algo salió mal, intentelo nuevamente <br>";
	  		echo '<a href="agregarproducto.php" >Volver a la pagina anterior</a>';
	  	}
