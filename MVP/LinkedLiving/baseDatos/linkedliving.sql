...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2019 a las 18:43:53
...
INSERT INTO `acuerdos` (`IdAcuerdo`, `IdArrendatario`, `IdEstudiante`, `IdUniversidad`, `Volante`) VALUES
(1, 1, 2, 3, 120000000),
(2, 2, 1, 4, 265700000),
(3, 4, 3, 1, 950000000),
(4, 5, 4, 3, 950000000);
...
INSERT INTO `habitaciones` (`IdHabitacion`, `Hospedaje`, `NumberRoom`, `Foto`) VALUES
(1, 2, 2, 'C:\\xampp\\htdocs\\LinkedLiving\\posts\\casa2.jpg'),
(2, 5, 4, 'C:\\xampp\\htdocs\\LinkedLiving\\posts\\casa5.jpg'),
(3, 3, 6, 'C:\\xampp\\htdocs\\LinkedLiving\\posts\\casa3.jpg'),
(4, 2, 1, 'C:\\xampp\\htdocs\\LinkedLiving\\posts\\casa2.jpg');
...
--
ALTER TABLE `acuerdos`
  MODIFY `IdAcuerdo` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `estudiante`
  MODIFY `IdEstudiante` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `habitaciones`
--
ALTER TABLE `habitaciones`
  MODIFY `IdHabitacion` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `locations`
  MODIFY `IdLocation` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
