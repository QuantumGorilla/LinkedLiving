...
<body>
  <form action="logines.php" method = "post">
      <input type="submit" type="submit" value="REGRESAR"/>
	</form>
     <section>
	   <center><form action="guardabaseUsuario.php" method = "post"><form action="guardaEstudiante.php" method = "post">
     ...
     <input type="text" name="universidad" class="form-control" id="universidad" placeholder="Escriba la universidad a la que pertenece"><br><br><br>
